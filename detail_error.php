                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" novalidate="novalidate">
                                            ...
                                            include './connect.php';
                                                ...
                                                $cmd1 = "SELECT * FROM human_error WHERE error_id='".$_GET['id']."'"; //okok
                                            ...
                                            <div class="form-group">
                                                ...
                                                value="<?echo ''.$row['email'].''; ?>" readonly disabled="">
                                            </div>
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea style="height: 200px" id="cc-number" name="no_karyawan" type="text" class="form-control cc-number identified visa" value="" data-val="true"
                                                    ...
                                                    autocomplete="cc-number" readonly=""><?echo ''.$row['message'].''; ?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-pament" name="category" type="text" class="form-control" aria-required="true" aria-invalid="false" 
                                                value="<?echo ''.$row['timestamp'].''; ?>" readonly disabled="">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select class="col-lg-11 form-control" onchange="location = this.value;">
                                                                 ...
                                                                 <option value="erstat_progress.php?id='.$row["error_id"].'">In Progress</option>
                                                                 <option value="erstat_solved.php?id='.$row["error_id"].'">Solved</option>
                                                                 <option value="delete_error.php?id='.$row["error_id"].'"><b>Delete<b></option>
                                                                </select>'
                                                                ?>
                                            </div>
