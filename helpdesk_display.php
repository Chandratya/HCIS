...
<head>
    ...
    <!-- Title Page-->
    <title>Display Helpdesk Result</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-lg-12">
                                    ...
                                    <h5 style="float: left; margin-left: 57px; color: green;">Request Total:  
                                    <?php 
                                    $hostname = "localhost";
                                    $database = "hcis";
                                    $username = "root";
                                    ...
                                    <h5 style="overflow: auto; margin-left: 20px; float: left; color: darkgreen;">Request In Progress:  
                                    <?php 
                                    $hostname = "localhost";
                                    $database = "hcis";
                                    $username = "root";
                                    ...
                                    ?></h5> 
                                    <h5 style="overflow: auto; margin-left: 27px; float: left; color: darkred;">Human Error In Progress:  
                                    <?php 
                                    $hostname = "localhost";
                                    $database = "hcis";
                                    $username = "root";
                                    ...
                                    <h5 style="overflow: auto; margin-left: 53px; float: left; color: darkgreen;">Request Solved:  
                                    <?php 
                                    $hostname = "localhost";
                                    $database = "hcis";
                                    $username = "root";
                                    ...
                                    <h5 style="overflow: auto; margin-left: 60px; float: left; color: darkred;">Human Error Solved:  
                                    <?php 
                                    $hostname = "localhost";
                                    $database = "hcis";
                                    $username = "root";
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    ...
                                    $query = mysql_query($sql1, $connect);
                                    ...
                                    while ($row = mysql_fetch_array($query)) //yg ini
                                    {
                                        echo '<tr>
                                                <td>'.$i.'</td>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    ...
                                    echo '<table id="request" style="display: inline-block; overflow-y: scroll; max-height: 350px;" class="table table-borderless table-striped table-earning">
                                            ...
                                            <tbody>';
                                          $i = 1;    
                                    while ($row = mysql_fetch_array($query)) //sini
                                    {
                                        echo '<tr>
                                                <td>'.$i.'</td>
                                                <td style="max-width: 100px; display:block; overflow: hidden; whitespace: nowrap; text-overflow: ellipsis;">'.$row['category_desc'].'</td>
