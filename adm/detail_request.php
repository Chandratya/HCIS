                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" novalidate="novalidate">
                                            ...
                                            include '../connect.php';
                                                ...
                                                $cmd1 = "SELECT * FROM request WHERE request_id='".$_GET['id']."'"; //okok
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="col-lg-11 form-control" onchange="location = this.value;">
                                                                 ...
                                                                 <option value="reqstat_progress.php?id='.$row["request_id"].'">In Progress</option>
                                                                 <option value="reqstat_solved.php?id='.$row["request_id"].'">Solved</option>
