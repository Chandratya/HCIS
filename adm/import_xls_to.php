...
if(isset($_POST['import'])){ // Jika user mengklik tombol Import
	...
	$sheet = $loadexcel->getActiveSheet()->toArray(true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true,true, true, true ,true);
	
	// Buat query Insert
	$query = "INSERT INTO turn_over VALUES";
	...
	foreach($sheet as $row){
		...
		$bb = $row['BB']; // Ambil data nama
		$bc = $row['BC']; // Ambil data jenis kelamin
		$bd = $row['BD']; // Ambil data telepon
		$be = $row['BE']; // Ambil data alamat
		$bf = $row['BF']; // Ambil data NIS
		$bg = $row['BG']; // Ambil data nama
		$bh = $row['BH']; // Ambil data jenis kelamin
		...
		if($numrow > 1){
			...
			$query .= "('".$a."','".$b."','".$c."','".$d."','".$e."','".$f."','".$g."','".$h."','".$i."','".$j."','".$k."','".$l."','".$m."','".$n."','".$o."','".$p."','".$q."','".$r."','".$s."','".$t."','".$u."','".$v."','".$w."','".$x."','".$y."','".$z."','".$aa."','".$ab."','".$ac."','".$ad."','".$ae."','".$af."','".$ag."','".$ah."','".$ai."','".$aj."','".$ak."','".$al."','".$am."','".$an."','".$ao."','".$ap."','".$aq."','".$ar."','".$as."','".$at."','".$au."','".$av."','".$aw."','".$ax."','".$ay."','".$az."','".$ba."','".$bb."','".$bc."','".$bd."','".$be."','".$bf."','".$bg."','".$bh."'),";
		}
	...
	echo "<script type='text/javascript'>alert('Import Data Berhasil!'); window.location='table2.php'; </script>";
}
