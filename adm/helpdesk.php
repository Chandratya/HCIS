...
<aside class="menu-sidebar d-none d-lg-block">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <a href="helpdesk_admin.php">
                <button style="margin-left: 100px; margin-bottom: 15px;" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="fa fa-cog"></i>SETUP item</button></a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form name="myForm" action="input_helpdesk.php" onsubmit="return validateForm()" method="post" novalidate="novalidate">
                                            <div class="form-group col-lg-12" style="float: left;">
                                                <label for="cc-payment" style="float: left;" class="control-label mb-1 text-left">Email <label style="color: red">*</label></label>
                                            ...
                                            <div class="form-group col-lg-6" style="float: left;">
                                                <label for="cc-payment" style="float: left;" class="control-label mb-1 text-left">Type<label style="color: red">*</label></label>
                                                <?php
                                                 $con = mysqli_connect("localhost","root","");
                                                 $db = mysqli_select_db($con,"hcis");
                                                 $get=mysqli_query($con, "SELECT type_id,type_desc FROM data_type ORDER BY type_id ASC");
                                                 $option = '';
                                            ...
                                            <div class="form-group has-success col-lg-6" style="float: left;">
                                                <label for="cc-name" style="float: left;" class="control-label mb-1">Category (Class)<label style="color: red">*</label></label>
                                                <?php
                                                 $con = mysqli_connect("localhost","root","");
                                                 $db = mysqli_select_db($con,"hcis");
                                                 $get=mysqli_query($con, "SELECT category_id,category_desc FROM category ORDER BY category_desc ASC");
                                                 $option = '';
                                                 while($row = mysqli_fetch_assoc($get))
                                                {
                                            ...
                                            <div class="form-group col-lg-12" style="float: left;">
                                                <label for="cc-number" style="float: left;" class="control-label mb-1">Title<label style="color: red">*</label></label>
                                            ...
                                            <div class="form-group col-lg-12" style="float: left;">
                                                <label for="cc-number" style="float: left;" class="control-label mb-1">Message<label style="color: red">*</label></label>
