...
<head>
    ...
    <!-- Title Page-->
    <title>Employee Turn Over Data</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="import_xls_to.php" method="post" name="import" id="frmCSVImport" enctype="multipart/form-data">
                                <div class="col-lg-12" style="width: 1000px; margin-bottom: 20px;">
                                    ...
                                    <a href="../Format.xlsx" style="float: right;">Download Format Excel</a>
                                </div>
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    ...
                                    echo '<table id="eto" style="display: inline-block; overflow-y: scroll; max-height: 350px;" class="table table-borderless table-striped table-earning">
                                          ...
                                          $i = 1;    
                                            $conn = mysqli_connect("localhost","root","","hcis");
                                           
                                            
                                       //     $result =  mysqli_query($quer, $conn);
