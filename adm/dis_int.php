...
<head>
    ...
    <!-- Title Page-->
    <title>Display Exit Interview</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    ...
                                    echo '<table id="exit_inter" style="display: inline-block; overflow-y: scroll; max-height: 350px;" class="table table-borderless table-striped table-earning">
                                            <thead>
                                                <tr>
                                                <th> Act </th>
                                                <th> No. </th>
                                ...
                                <a href="#" onclick="$('#exit_inter').tableExport({type:'excel',escape:'false', ignoreColumn:'[1]'});" style="float: right;"><button style="font-size: 9px" class="au-btn au-btn-icon au-btn--green au-btn--small">
