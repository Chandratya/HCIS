...
if(isset($_POST['submit'])){
    ...
    $cmd = "INSERT INTO exit_inter VALUES('$nama', '$jabatan', '$dept', '$nik', '$datein','$dateout','$q1','$q2','$q3','$asp1','$asp2','$asp3','$asp4','$asp5','$asp6','$asp7','$cmt')";
    $query = mysql_query($cmd,$connect);
    if($query!=false){
        $message = "Data Exit Interview Berhasil Ditambahkan!";
        echo "<script type='text/javascript'>alert('$message'); window.location='exitform.php';</script>";
    }else{
        echo "0";
